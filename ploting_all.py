...
def plot_all(combined_df, cb_diff_df, increase_etf=True):
    ...
    plt.bar(cb_diff_df.index, cb_diff_df['diff_etf'], label='diff_etf', width=60, color='r')
    plt.bar(cb_diff_df.index, cb_diff_df['diff_ind'], label=f'diff_ind', width=30, color='b')
